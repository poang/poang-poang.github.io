...
示例1：![img](https://assets.leetcode.com/uploads/2018/12/07/circularlinkedlist.png)
...
### [#](https://programmercarl.com/0142.环形链表II.html#判断链表是否有环)判断链表是否有环
...
### [#](https://programmercarl.com/0142.环形链表II.html#如果有环-如何找到这个环的入口)如果有环，如何找到这个环的入口
...
需要推导过程，通过找到相遇的位置，推导出x=z，然后两指针再次相遇即为环的入口。秒啊。